...
//     const target = components.find((component) => component.types.includes(type))
//     return target?.[key] || ''
// }
...
//         []
//     )
//     const googleKeyError = !googleApiKey
//         ? 'Google Places key is missing. Please configure it in .env.'
//         : null
...
//                 setPlacesError('Unable to load Google Places at the moment.')
//             })
//             return
//         }
...
//         script.onerror = () => setPlacesError('Unable to load Google Places at the moment.')

//         document.body.appendChild(script)
//     }, [googleApiKey])

//     useEffect(() => {
//         if (!googleReady || !addressLine1Ref.current || !window.google?.maps?.places) {
//             return
//         }

//         const autocomplete = new window.google.maps.places.Autocomplete(addressLine1Ref.current, {
...
//                 setPlacesError('Selected address does not contain a valid location. Please choose another result.')
//                 return
//             }
...
//             setValue('addressLine1', place.formatted_address || addressLine1Ref.current?.value || '')
//             setValue('city', getAddressComponent(components, 'locality'))
//             setValue('state', getAddressComponent(components, 'administrative_area_level_1'))
//             setValue('zipCode', getAddressComponent(components, 'postal_code'))
//             setValue('country', getAddressComponent(components, 'country'))
//         })
//     }, [googleReady, setValue])

//     const submitHandler = async (values: AddressFormData) => {
//         if (!location) {
//             setPlacesError('Please choose an address suggestion so we can capture location coordinates.')
//             return
//         }
...
//                                 ref={(element) => {
//                                     register('addressLine1').ref(element)
//                                     addressLine1Ref.current = element
//                                 }}
...
//                         {(googleKeyError || placesError || saveError) && (
